...
Los músculos artificiales, también conocidos como **actuadores de tipo muscular**, son materiales o dispositivos que imitan el músculo natural y pueden cambiar su rigidez, contraerse reversiblemente, expandirse o girar dentro de un componente debido a un estímulo externo (como el voltaje, la corriente, la presión o la temperatura).

Las tres respuestas básicas de actuación: contracción, expansión y rotación, pueden combinarse dentro de un mismo componente para producir otros tipos de movimientos (por ejemplo, la flexión, contrayendo un lado del material mientras se expande el otro).
...
# Actuadores genéricos disponibles en Webots
...
- Freno: simulación de frenado mecánico
- Conector: sistema de acoplamiento mecánico y rompible (como un lego)
- Pantalla
...
- Track: Simula una pista que se puede usar tanto como cintas transportadoras como ruedas-oruga
