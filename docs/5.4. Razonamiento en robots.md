...
Un robot es una tipo de aplicación muy diferente a otras:
...
- Existencia un flujo único entre percepción y acción para cada comportamiento.
...
Se suelen descomponer, a su ven en más o menos componentes.
