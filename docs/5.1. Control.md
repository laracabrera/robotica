...
Estudia como **llevar sistemas a estados deseados** en función de sus entradas:

- **Minimizar** el **tiempo** de ajuste, rebasamiento y error estacionario.
- **Garantizando** un nivel de **estabilidad** de control.
- **Persiguiendo** el grado de **optimalidad**.

A las entradas también se las denomina **referencia**.

---

Dentro de la teoría de control existen también otros dos aspectos de estudio:

- **Controlabilidad**: Capacidad de alterar un sistema utilizando sólo ciertas manipulaciones admisibles.
...
- En ella se trata de mantener al máximo la variedad (e.g. compresión de datos).

---

# Control<!--_class: transition-->

---

# Controladores clasicos con realimentación:
